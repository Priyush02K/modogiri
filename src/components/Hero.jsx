...
const SLIDES = [
  ...
  },
  {
    id: '02',
    category: 'Portfolio',
    title: 'Boutique cottage in a Farmstay',
    subtitle:
      'Crafted with traditional wattle, daub, and lime plaster, this boutique cottage radiates a rich, beautifully earthy warmth.',
    tag: 'Auroville, India',
  ...
  },
  {
    id: '03',
    category: 'Workshops',
    title: 'Earth Immersion Programs',
    subtitle:
      'Join our immersive hands-on programs. Learn through vernacular wisdom.',
  ...
  },
  {
    ...
    title: 'Our Offerings ',
    subtitle:
      'From sculpted wall closets to artisan home decor, stumble upon our community-crafted collections currently brewing.',
    ...
    <section className="relative min-h-screen pt-24 pb-0 flex flex-col justify-end bg-[#FFFAF5] dark:bg-[#0a0a0a] transition-colors duration-500 overflow-x-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none grid grid-cols-4 md:grid-cols-12 gap-6 px-6 md:px-12 z-0 opacity-50">
        {[...Array(13)].map((_, i) => (
          <div
            key={i}
            className="h-full border-l border-black/[0.04] dark:border-white/[0.03] hidden md:block"
          />
        ))}
      </div>
      ...
      <div className="max-w-[1400px] mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 flex-grow">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                  ...
                  {SLIDES[current].title
                    ...
                    .map((word, i) => (
                      <React.Fragment key={i}>
                        ...
                        {i === 1 ? (
                          <span className="italic text-gray-400 dark:text-gray-500 font-light mr-3 inline-block">
                            {word}
                          </span>
                        ) : (
                ...
                <button
                  ...
                  className="group flex items-center gap-4 w-fit text-black dark:text-white"
                >
                  ...
                  <div
                    className={`w-10 h-10 rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center transition-all duration-300 ${
                      current >= 2
                        ? 'bg-black dark:bg-white text-white dark:text-black group-hover:bg-orange-600 group-hover:border-orange-600 group-hover:text-white'
        ...
        <div className="lg:col-span-7 relative h-[50vh] lg:min-h-[80vh] w-full order-1 lg:order-2 overflow-hidden px-4 lg:px-0 lg:pr-6 lg:pb-6 pt-4 lg:pt-6">
          ...
          <div className="w-full h-full relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            {/* Design Accents */}
            <div className="absolute top-6 right-6 text-white/60 text-xs font-mono z-10 hidden md:block">
              +
            </div>

            <div className="absolute bottom-6 right-6 text-white/60 text-xs font-mono z-10 hidden md:block">
              +
            </div>
