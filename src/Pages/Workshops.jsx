...
<div className="bg-[#F5F2ED] dark:bg-[#0a0a0a] transition-colors duration-700 font-sans text-stone-900 dark:text-stone-100 min-h-screen overflow-x-hidden selection:bg-orange-600 selection:text-white pt-24">      {/* --- SECTION 1: CINEMATIC COVER HERO --- */}
        ...
        <div className="max-w-[1400px] mx-auto w-full px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-3xl font-serif text-stone-300 leading-tight max-w-2xl italic border-l border-white/20 pl-8">
              "A unified approach to hands-on architectural education and
              material research."
            </p>
          </motion.div>
        </div>
                ...
                <div className="space-y-12">
                  <div className="relative aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl border border-stone-200 dark:border-white/5 group">
                    ...
                    <div className="absolute bottom-12 left-12 right-12 text-white">
                      <p className="text-[10px] uppercase font-black tracking-[0.4em] text-orange-500 mb-4">
                        Active Session ID
                      </p>
                      <p className="text-6xl md:text-7xl font-serif leading-none tracking-tighter">
                        {randomRef}
                      </p>
                  ...
                  <div className="flex flex-col gap-6 text-stone-400 text-sm font-medium border-t border-stone-100 dark:border-stone-800 pt-10">
                    <p className="flex items-center gap-4">
                      ...
                      Enrollment is limited to ensure technical depth.
                    </p>
                    <p className="flex items-center gap-4">
                      <MapPin size={16} className="text-orange-600" /> Sessions
                      held at our material research labs.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {bookingStatus === "success" && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              className="bg-[#F5F2ED] dark:bg-[#111] p-10 md:p-20 rounded-[4rem] text-center max-w-2xl shadow-2xl border border-white/5"
            >
              <div className="w-24 h-24 rounded-full bg-orange-600 flex items-center justify-center text-white mb-12 mx-auto shadow-[0_0_60px_rgba(234,88,12,0.4)]">
                <Check size={54} strokeWidth={3} />
              </div>
              <h4 className="text-5xl md:text-6xl font-serif mb-8 tracking-tighter text-stone-900 dark:text-stone-100 leading-none">
                Registration <br />
                Successful.
              </h4>
              <p className="text-stone-500 dark:text-stone-400 italic font-serif text-xl mb-14">
                Your reference{" "}
                <span className="text-orange-600 font-bold not-italic">
                  #{randomRef}
                </span>{" "}
                has been logged. We will reach out shortly.
              </p>
              <button
                onClick={() => setBookingStatus("idle")}
                className="px-16 py-6 bg-stone-900 dark:bg-white text-white dark:text-stone-900 rounded-full text-[10px] uppercase font-black tracking-[0.3em] shadow-2xl hover:scale-105 transition-all"
              >
                Finish Registration
              </button>
            </motion.div>
